...
BEGIN
    ...
    SELECT 1 AS Resultado, 'Laboratorio agregado correctamente' AS Mensaje;
END;
GO

CREATE OR ALTER PROCEDURE SP_ObtenerLaboratorioPorId
    @IdLaboratorio INT
AS
BEGIN
    SET NOCOUNT ON;
...
CREATE OR ALTER PROCEDURE SP_RecuperarMedicamentosActivos
AS
BEGIN
    SET NOCOUNT ON;
    SELECT m.IdMedicamento, m.IdLaboratorio, m.IdCategoria, m.Nombre, m.Descripcion,
...
CREATE OR ALTER PROCEDURE SP_ObtenerMedicamentoPorId
    @IdMedicamento INT
AS
BEGIN
    SET NOCOUNT ON;
