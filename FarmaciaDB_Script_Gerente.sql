...
-- 1. Unidades vendidas en el periodo actual
...
-- 2. Unidades vendidas en el periodo del mes anterior
...
-- 3. Calcular porcentaje de variaci�n (evitando divisi�n por cero)
